...
namespace Harris.GPC
{
	...
	public class ThreeWayShooter : BaseWeaponScript
	{
		...
		public override void FireProjectile(Vector3 fireDirection, int ownerID)
		{
			...
			_theProjectile.GetComponent<Rigidbody>().linearVelocity = fireDirection * projectileSpeed;
			...
			// add some force to move our projectile
			_theProjectile.GetComponent<Rigidbody>().linearVelocity = offsetSideFireVector + fireDirection * projectileSpeed;
